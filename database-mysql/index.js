...
const uploadProdCSV = () => {
  ...
  const prodQry4 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/product/product.csv5' INTO TABLE products FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
  const prodQry5 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/product/product.csv6' INTO TABLE products FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
  const prodQry6 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/product/product.csv7' INTO TABLE products FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
...
const uploadRevCSV = () => {
  ...
  const revQry4 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/review/review.csv4' INTO TABLE review FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
  const revQry5 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/review/review.csv5' INTO TABLE review FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
  const revQry6 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/review/review.csv6' INTO TABLE review FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
  const revQry7 = "LOAD DATA LOCAL INFILE '/home/ec2-user/service-reviews/CSV/review/review.csv7' INTO TABLE review FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';";
